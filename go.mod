module github.com/platform-engineering-labs/formae-plugin-oci
...
require (
	...
	github.com/platform-engineering-labs/formae/pkg/model v0.1.5-0.20260212053706-9e9f3f1b21ec
