...
DISCOVERY_DEFAULT_FILTER := policy,vcn,volume,bucket,networksecuritygroup,internetgateway,routetable,securitylist,subnet,dhcpoptions,networksecuritygroupsecurityrule
