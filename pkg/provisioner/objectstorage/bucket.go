...
func (p *BucketProvisioner) Delete(ctx context.Context, request *resource.DeleteRequest) (*resource.DeleteResult, error) {
	...
	namespaceResp, err := client.GetNamespace(ctx, namespaceReq)
	if err != nil {
...
func (p *BucketProvisioner) List(ctx context.Context, request *resource.ListRequest) (*resource.ListResult, error) {
	...
	// Fetch the Object Storage namespace dynamically
	// Namespace is a tenant-wide unique identifier that's separate from compartment
	namespaceReq := objectstorage.GetNamespaceRequest{}
	namespaceResp, err := client.GetNamespace(ctx, namespaceReq)
	if err != nil {
		return nil, fmt.Errorf("failed to get Object Storage namespace: %w", err)
